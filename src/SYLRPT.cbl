*****************************************************************
      ...
      *****************************************************************
       ...
       01 WS-REPORT-LINES.
          05 WS-HEADER-LINE-1.
             10 FILLER               PIC X(20) VALUE "シラバス管理システム".
             10 FILLER               PIC X(30) VALUE SPACES.
             10 FILLER               PIC X(10) VALUE "日付: ".
             10 WS-DATE-OUT          PIC X(10).
             10 FILLER               PIC X(05) VALUE SPACES.
             10 FILLER               PIC X(05) VALUE "ページ:".
          ...
          05 WS-HEADER-LINE-3.
             10 FILLER               PIC X(10) VALUE "科目コード".
             10 FILLER               PIC X(02) VALUE SPACES.
             10 FILLER               PIC X(20) VALUE "科目名".
             10 FILLER               PIC X(02) VALUE SPACES.
             10 FILLER               PIC X(04) VALUE "学部".
             10 FILLER               PIC X(02) VALUE SPACES.
             10 FILLER               PIC X(05) VALUE "教員".
             10 FILLER               PIC X(02) VALUE SPACES.
             10 FILLER               PIC X(02) VALUE "学期".
             10 FILLER               PIC X(02) VALUE SPACES.
             10 FILLER               PIC X(03) VALUE "単位".
       ...
       PROCESS-RECORD-FOR-REPORT.
           IF RECORD-MATCHES-REPORT-FILTER
